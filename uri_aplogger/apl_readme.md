...
- `spectro_timestamped.py` - Outlier sensor that reads data with a custom library, and not by serial, required a separate class.
...
WIPs:
- `spectro_hdf5.py` and `read_hdf5.py` - Unfinished approach to reading 2048 data columns from spectrometer.
